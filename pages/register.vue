        ...
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="text"
              ...
              placeholder="Write Your Name Here" value="Julia Keeva Hanna" v-model="register.name" />
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="text"
              class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
              placeholder="Write your occupation here" value="Graphic Designer" v-model="register.occupation" />
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="email"
              class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
              placeholder="Write your email address here" value="julia.keeva@gmail.com" v-model="register.email"/>
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="password"
              class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
              placeholder="Type your password here" value="nasigorenglimaribbu" v-model="register.password" @keyup.enter="userRegister"/>
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
