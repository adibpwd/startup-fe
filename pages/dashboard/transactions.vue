      ...
      <div class="flex justify-between items-center mb-6">
        <div class="w-3/4 mr-6">
          ...
          <ul class="flex mt-2">
            ...
            <li class="mr-6">
              <a class="text-gray-800 font-bold" href="/dashboard/transactions.html">
                Your Transactions
              </a>
            </li>
          </ul>
      ...
      <div class="block mb-2">
        <div class="w-full lg:max-w-full lg:flex mb-4" v-for="transaction in transactions.data" :key="transaction.id">
          <div
            ...
            :style="'background-color: #bbb; background-position: center; background-image: url(\'' + $axios.defaults.baseURL + '/' + transaction.campaign.image_url + '\')' "></div>
          <div
            ...
            <div>
              ...
              <p class="text-sm text-gray-600 flex items-center mb-2">
                  Rp. {{ new Intl.NumberFormat().format(transaction.amount) }} &middot; harusnya date > next time i will change {{ transaction.created_at }} &middot; {{ transaction.status }}
              </p>
            </div>
          </div>
        </div>
