      ...
      <div class="grid grid-cols-3 gap-4 mt-3">
        ...
        class="card-project w-full p-5 border border-gray-500 rounded-20">
          <div class="item">
            ...
            class="text-center mt-5 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full">Found Now</button>
          </div>
        </div>
      </div>
    </section>
